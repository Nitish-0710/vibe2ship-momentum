...
export default function SignupPage() {
  const { signup, loginWithGoogle, firebaseUser, loading, error, clearError } = useAuth()
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>
            Your AI Chief of Staff is ready to help you execute
          </p>
        </div>
        ...
        <div className="glass rounded-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              type="submit"
              disabled={submitting}
              className="w-full py-3 px-4 rounded-xl font-semibold text-sm text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-[1.01] active:scale-[0.99]"
              style={{
